...
export default class MorePostsInfo extends React.PureComponent {
  ...
  render() {
    ...
    const boderStyle = { borderRadius: '4px' };

    return (
      <Container>
        <Segment style={boderStyle}>
          <Header as='h3' attached='top' dividing className="ui-background">
            Related Videos
          </Header>
          <Segment attached className="ui-background">
